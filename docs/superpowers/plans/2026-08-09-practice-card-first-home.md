...
**Goal:** Remove the “练习” and “随机” chrome from the practice home so a populated question card moves upward and becomes the page’s primary visual focus.
...
- [x] **Step 1: Record the current failing visual contract**
...
- [x] **Step 2: Remove the root practice navigation title**
...
- [x] **Step 3: Remove the populated-feed header row**
...
- [x] **Step 4: Verify the removed chrome is absent from source**
...
- [x] **Step 2: Build the simulator application**
...
- [x] **Step 3: Install and launch on the exact simulator only**
...
- [x] **Step 4: Perform Computer Use visual acceptance**
...
- [x] **Step 5: Audit unchanged behavior and the focused diff**
